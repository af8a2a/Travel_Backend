...
public class RestaurantServiceImpl extends ServiceImpl<RestaurantMapper, Restaurant> implements RestaurantService {
    ...
    @Override
    public RestaurantResponse All(Integer page) {
    ...
    @Override
    public RestaurantResponse Search(String name, Integer page) {
        RestaurantResponse response=new RestaurantResponse();
        List<Restaurant> restaurants=restaurantMapper.selectList(new QueryWrapper<Restaurant>()
                .lambda().like(Restaurant::getName,name));
        response.setRestaurants(restaurants);
    ...
    @Override
    public RestaurantResponse Delete(Integer id) {
        RestaurantResponse response=new RestaurantResponse();
        QueryWrapper<Restaurant> queryWrapper =new QueryWrapper<>();
        queryWrapper.lambda().like(Restaurant::getId,id);
    ...
    @Override
    public RestaurantResponse Details(Integer id) {
        RestaurantResponse response=new RestaurantResponse();
        QueryWrapper<Restaurant> queryWrapper = new QueryWrapper<>();
        queryWrapper.lambda().eq(Restaurant::getId,id);
